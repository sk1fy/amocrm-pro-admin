...
Четыре этапа. Каждый заканчивается работающим приложением с реальными данными
доступного бекенда; тестовые данные допустимы только с явной пометкой
происхождения. Исходное задание — в истории репозитория; этот план — его
адаптация к фактическому коду `amocrm-pro` на 2026-09-12 (`main`, `76e89ef`).
...
| Этап | Цель | Файл |
| --- | --- | --- |
| 1 | Основа приложения и просмотр аккаунтов | [stage-1.md](stage-1.md) |
| 2 | Управление и восстановительные операции | [stage-2.md](stage-2.md) |
| 3 | Управление текущими модулями и статистика | [stage-3.md](stage-3.md) |
| 4 | Подключение будущих бекендов и выпуск | [stage-4.md](stage-4.md) |
